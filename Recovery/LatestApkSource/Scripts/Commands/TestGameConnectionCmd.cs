...
public class TestGameConnectionCmd : ICommand
{
	private readonly GameManager _gameManager;

	private readonly ApiGateway _apiGateway;

	public TestGameConnectionCmd(GameManager gameManager, ApiGateway apiGateway)
	{
	...
	public void Execute()
	{
		_apiGateway.GetConnection(_gameManager).DoOnError(delegate
		{
