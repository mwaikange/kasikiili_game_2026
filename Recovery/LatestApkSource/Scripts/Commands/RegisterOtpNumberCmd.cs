...
public class RegisterOtpNumberCmd : ICommand
{
	...
	public RegisterOtpNumberCmd(GameManager gameManager, MenuManager menuManager, string mobileNo, UserGateway userGateway)
	{
	...
	public void Execute()
	{
		_userGateway.RegisterOtpNumber(_gameManager, _mobileNo).DoOnError(HandleLoginError).DoOnError(Debug.LogError)
			.Do(delegate
			{
				SignUpFlow();
			})
